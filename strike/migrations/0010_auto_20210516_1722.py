# Generated by Django 3.2.3 on 2021-05-16 11:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('strike', '0009_auto_20210516_1703'),
    ]

    operations = [
        migrations.RenameField(
            model_name='demandcategory',
            old_name='demand_categories',
            new_name='demand_type',
        ),
        migrations.AlterField(
            model_name='card',
            name='end_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 16, 17, 22, 52, 894994), verbose_name='Дата конца проведения забастовки/акции'),
        ),
        migrations.AlterField(
            model_name='card',
            name='start_date',
            field=models.DateTimeField(default=datetime.datetime(2021, 5, 16, 17, 22, 52, 894994), verbose_name='Дата начало проведения забастовки/акции'),
        ),
