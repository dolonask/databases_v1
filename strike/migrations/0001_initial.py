    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата конца проведения забастовки/акции')),
                ...
                ('story', models.TextField(blank=True, max_length=3600, verbose_name='Укажите ПОСЛЕДОВАТЕЛЬНО, что произошло. Параллельно указывайте, чем подтверждаются эти факты (если есть приложения, укажите сразу номера и названия соответствующих приложений) ')),
                ('reasons_for_strike', models.TextField(blank=True, max_length=3600, verbose_name='Опишите причины начала забастовки (например: условия труда на предприятии, продолжительность рабочего времени, безопасность и т.д. время, связанное с работой)')),
                ('change_number_participants', models.TextField(blank=True, max_length=3600, verbose_name='Опишите как менялось количество участников забастовки во время проведения и что на это влияло?')),
                ('initiators_and_participants', models.TextField(blank=True, max_length=3600, verbose_name='Ситуация с инициаторами и участниками забастовки/акции (продолжают ли они работать, применялись ли к ним административные меры со стороны предприятия). ')),
                ('state_position', models.TextField(blank=True, max_length=3600, verbose_name='Позиция государства (Опишите реакцию государственных органов)')),
                ('results_so_far', models.TextField(blank=True, max_length=3600, verbose_name='Опишите, с какими итогами закончилась забастовка, если еще не закончилась, то какие итоги на данный момент.')),
                ('additional_information', models.TextField(blank=True, max_length=3600, null=True, verbose_name='Любая дополнительная информация')),
                ('case_text', models.TextField(blank=True, max_length=1800, null=True, verbose_name='Окно для внесения информации')),
                ('added_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Монитор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual_name', models.CharField(blank=True, max_length=150, verbose_name='ФИО')),
                ...
                ('age', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='strike.age', verbose_name='Возраст')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.FileField(blank=True, upload_to='document/%Y/%m/%d/', verbose_name='Фото/видео/документы')),
                ('card', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='strike.card')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, upload_to=strike.models.files_location, verbose_name='Кейсы, связанные с данной ситуацией')),
                ('card', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='strike.card')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True, verbose_name='Активен')),
                ('date_create', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='strike.card')),
            ],
            options={
